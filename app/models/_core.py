...
#
# Bump CURRENT_SCHEMA_VERSION and register a migration callable when adding
# or altering a column. Each migration takes the open connection and issues
...
#
# Migration callables live one-per-file under app/models/migrations/v<N>.py.
# The registry assembly is in app/models/migrations/__init__.py; bumping
# the schema is "drop a new file in, bump CURRENT_SCHEMA_VERSION, append
# to that registry."
# -----------------------------------------------------------------------------
