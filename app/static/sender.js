// ES module. Top-level code runs once on import; the html file loads this
// via <script type="module">. Split into sender/*.js submodules is a
// follow-up; today this file is still monolithic, just no longer an IIFE.
